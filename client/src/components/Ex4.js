...
function Ex4 () {
    ...
    const [search,setSearch]=useState(null);
        ...
        axios.get('https://api.github.com/users/defunkt/following',{}).then((response)=>{
    ...
    <p style={{color:"red"}}>values available to search [1,3, 17, 19,21, 23,25, 26,36,38,46, 47,48,49,68,69,70, 80,90, 100, 105, 108, 118, 124, 127, 137, 138, 139, 141, 143] to Retrieve it</p>
    </div> 
    </div>
    );
    }else {
